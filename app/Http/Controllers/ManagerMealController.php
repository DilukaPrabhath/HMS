...
class ManagerMealController extends Controller
{
    ...
    public function index(){
        ...
        return view('backend.manager.meals.meal_items');
     }
     ...
     public function store(Request $request)
    {
        ...
        return redirect('manager/mealitems')->with($notification);
     ...
     public function edit($id)
    {
       ...
       // $mealitems = meal_items::all();
        return view('backend.manager.meals.edit',compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('manager/category')->with($notification);
