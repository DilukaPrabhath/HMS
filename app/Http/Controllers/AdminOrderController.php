...
class AdminOrderController extends Controller
{
    ...
    public function orderpending(){
        $orders =order::PendingOrderAdmin();
        return view('backend.admin.order.pending_order',compact('orders'));
     }
     public function ordercomplete(){
        $orders =order::CompleteOrderAdmin();
        return view('backend.admin.order.complete_order',compact('orders'));
     }

     //    public function OrderFeedback($id){
     //    $feedback =order::FeedbackOrderView($id);
     //    return view('backend.admin.order.feedback_order',compact('feedback'));
     // }
     ...
     function fetchfeedback(Request $request)
{
 ...
 public function fetchname(Request $request)
 {
     ...
     public function store(Request $request)
    {
        ...
        return redirect('admin/pendingOrder')->with($notification);
