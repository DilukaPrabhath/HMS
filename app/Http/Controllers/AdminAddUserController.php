...
class AdminAddUserController extends Controller
{
    ...
    public function index(){
     ...
     public function nonsystem(){
        $roomboy = roomboy::all();
        return view('backend.admin.user.non_system_emp',compact('roomboy'));
     }
     public function createroomboy(){
        ...
        ->groupBy('province')
        ->get();
        return view('backend.admin.user.add_non_system_emp',compact('usertype','address'));
     }
     ...
     public function create(){
        ...
        ->groupBy('province')
        ->get();
        return view('backend.admin.user.create',compact('usertype','address'));
     }
...
Mail::send('backend.admin.user.roomboy_mail', $data , function($message){
$message->to(Input::get('email'), Input::get('fname').' '.Input::get('lname'))->subject('Welcome to the Hotel Grand Opera');
});
     ...
     public function view($id)
    {
        $user = User::find($id);
       $data = user_type::all();
        return view('backend.admin.user.view',compact('user','data'));
    ...
    public function edit($id)
    {
        $user = User::find($id);
        $data = user_type::all();
        return view('backend.admin.user.edit',compact('user','data'));
    }
