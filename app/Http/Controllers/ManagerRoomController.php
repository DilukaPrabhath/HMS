...
class ManagerRoomController extends Controller
{
     ...
     public function index1()
    {
        ...
        return view('backend.manager.room.reserved_room',compact('rooms'));
    }

    public function index2()
    {
        $rooms = customer::AvailableRoom();
        return view('backend.manager.room.available_rooms',compact('rooms'));
    }
     public function index3()
    {
        $rooms = customer::ReleaseRoom();
        return view('backend.manager.room.release_room',compact('rooms'));
    }
    ...
    {
        return view('backend.manager.room.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('manager/rooms')->with($notification);

     }
    public function view()
    {
        $rooms = room::all();
        return view('backend.manager.room.view',compact('rooms'));
    }
    ...
    function fetchroom(Request $request)
{
     ...
     public function edit2($id)
    {
        $data = room::find($id);
        $room = room::all();
        return view('backend.manager.room.edit_room',compact('room','data'));
    }
