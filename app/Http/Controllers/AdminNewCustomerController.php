...
class AdminNewCustomerController extends Controller
{
    ...
    public function create(){
        ...
        ->groupBy('province')
        ->get();
         return view('backend.admin.customer.create',compact('customers','address'));
     }
    ...
    function fetch(Request $request)
{
    ...
    public function store(Request $request)
    {
        ...
        'fname'       => 'required',
        'lname'    => 'required',
        'nic'    => 'required|min:10|max:10|unique:customers',
        'line1'    => 'required',
        'line2'    => 'required',
        'line3'    => 'required',
        'city'    => 'required',
        ...
        'mobile'     => 'required|min:10|max:10',
          ...
          $roomno = room::select('room_no')->where('room_no',$roomname)->get();
          $rid2 = $roomno[0]->room_no;
        ...
        Mail::send('backend.admin.customer.customer_mail', $data , function($message){
     ...
     public function view($id)
    {
        ...
        return view('backend.admin.customer.view',compact('data'));
    ...
    public function edit($id)
    {
      $data = customer::customerDataEditid($id);
        return view('backend.admin.customer.edit',compact('data'));
    }
    ...
    public function checkout($id)
    {
        $data = customer::Checkout($id);
         return view('backend.admin.customer.checkout',compact('data'));
     }
    ...
    public function updatecheckout(Request $request ,$id)
    {
        ...
        $checkout = new checkout_histories;
        $checkout->customer_id = $custid;
        $checkout->room_type = $request->type;
        $checkout->room_no = $request->room_name;
        $checkout->room_price = $roomp;
        $checkout->order_price = $orderp;
        $checkout->total_price = $fulltotal;
        ...
        return redirect('admin/customers/checkinlist')->with($notification);
     ...
     public function checkinlist()
    {
      $checkin = customer::CheckinList();
        return view('backend.admin.customer.checkin_list',compact('checkin'));
        
     }
      public function checkoutlist()
    {
      $checkout = customer::CheckoutList();
        return view('backend.admin.customer.checkout_list',compact('checkout'));
        
     }
     public function print()
    {
        return view('backend.admin.customer.print_receipt');
        
     }
     public function printreceipt($id)
    {
        $print = customer::Checkout($id);
         return view('backend.admin.customer.print_receipt',compact('print'));
     }
}
