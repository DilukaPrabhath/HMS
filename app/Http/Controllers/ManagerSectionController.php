...
class ManagerSectionController extends Controller
{
    public function index()
    {
        return view('backend.manager.section.add_section');
        
     }
     public function index2()
    {
        return view('backend.manager.customer.add_service');
     ...
     public function store(Request $request)
    {
        ...
        return redirect('manager/add/section')->with($notification);

     }
      public function view()
    {
        $data = section::Sectiondata();
        return view('backend.manager.section.view_section',compact('data'));
        
 
    }
    public function getCusdetails1(Request $request)
    {
    ...
    $custid = $cust->id;
        ...
        return redirect('manager/add/section/customer')->with($notification);
}
}
