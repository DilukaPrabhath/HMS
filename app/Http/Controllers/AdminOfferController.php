...
class AdminOfferController extends Controller
{
    ...
    public function index(){
        $offer = offers::all();
        return view('backend.admin.meals.item_offer',compact('offer'));
     }

	public function create()
    {
        return view('backend.admin.meals.item_offer');
	...
	public function store(Request $request)
    {
        ...
        $this->validate(request(), [
            ...
            'offername'       => 'required|unique:offer_type,offer_name',
            'offerprice'   => 'required',
            'start'   => 'required',
            'end'   => 'required',
    ...
    {
        $data = offers::find($id);
        return view('backend.admin.meals.offer_edit',compact('data'));
    }
