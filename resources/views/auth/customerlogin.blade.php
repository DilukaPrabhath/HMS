...
<body class="bg-gradient" style="background: linear-gradient(90deg, #000000 0%, #D1D0CE 100%);">
 <style type="text/css">
           
            .bg1{
              background-image: url('https://media.edgeprop.my/s3fs-public/editorial/my/2021/March/31/hotel.jpg');
            }
      ...
      <div class="col-xl-10 col-lg col-md">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
             <div class="col-lg-6 d-none d-lg-block bg1"></div>
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Welcome to Our Hotel</h1>
                  </div>
