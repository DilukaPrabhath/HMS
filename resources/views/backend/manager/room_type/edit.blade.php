...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <form method="post" action="{{url('manager/room_type/edit/update')}}/{{$data->id}}" enctype="multipart/form-data"> {{ csrf_field() }}
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <button type="submit" class="btn btn-dark">Submit</button> <a href="{{url('manager/room_type')}}" class="btn btn-info">Back</a> </div>
          <div class="form-group col-md-6">
