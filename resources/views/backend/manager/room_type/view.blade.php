...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-dark">View Room Type</h6> </div>
    <div class="card-body">
          ...
          <div class="form-group col-md-6">
            ...
            <div class="form-row">
              <div class="form-group col-md-10">
                ...
                <input type="file" name="icon" style="text-align: center;" id="input-file-now-custom-2 " class="dropify" data-max-height="3000" data-height="250" data-max-file-size="1M" data-default-file="{{url('Upload/RoomTypes/'.$data->icon)}}" data-allowed-formats="landscape" /> @error('icon')
                <div class="alert" style="color: red;padding-left: 0px;">{{ $message }}</div> @enderror </div>
            </div>
            <div class="form-row">
            ...
            <!-- <a href="{{url('superadmin/room_type')}}"  class="btn btn-info">Back</a> --></div>
          <div class="form-group col-md-6">
