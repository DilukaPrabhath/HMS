...
<form class="customer" method="POST" action="{{url('manager/customers/save')}}"> {{csrf_field()}}
...
$(document).ready(function() {
  $('.dynamic').change(function() {
    if($(this).val() != '') {
      ...
      $.ajax({
        url: "{{ route('mng/dynamic_dependent/fetch') }}",
        method: "POST",
        data: {
          select: select,
          value: value,
...
$(document).ready(function() {
  $('.dynamic').change(function() {
    if($(this).val() != '') {
      ...
      var _token = $('input[name="_token"]').val();
      $.ajax({
        url: "{{ route('manager/dynamic_dependent/fetchroom') }}",
        method: "POST",
        data: {
          select: select,
          value: value,
