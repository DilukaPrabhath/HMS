...
<div class="card shadow mb-4">
  <div class="card-header py-3">
      <table width="100%">
          <tr>
            <td><h5 class="m-0 font-weight-bold text-dark col-md-4">Customer Table</h5></td>
          </tr>     
    </table>
  </div>
  <div class="card-body">
    <div class="table-responsive">
      ...
      <thead style="background-color:#F5F5F5;">
                    ...
                    <td class="project-actions">
                          <a class="btn btn-info btn-circle btn-sm" href="{{url('manager/customers/view')}}/{{$value->id}}">
                              <i class="fa fa-eye">
                              </i>
                          </a>
                      </td>
