...
<div class="container-fluid">
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"></h1> <a href="{{url('manager/room/add')}}" class="btn btn-dark btn-circle btn-lg"><i class="fas fa-plus"></i></a> </div>
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
          ...
          <tbody> @foreach($rooms as $value)
            <tr>
              ...
              <td class="project-actions">
                <a class="btn btn-danger btn-circle btn-sm" href="{{url('manager/room/edit')}}/{{$value->id}}"> <i class="fa fa-edit" aria-hidden="true"></i> </i>
                </a>
              </td>
            </tr> @endforeach </tbody>
        </table>
