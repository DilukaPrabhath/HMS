...
<div class="card shadow mb-4">
  <div class="card-header py-3">
      <table width="100%">
          <tr>
            ...
            <td><a href="{{url('manager/mealitems')}}" class="col-md-4 btn btn-block btn-dark float-right">Add Meal Items</a></td>
          </tr>        
    </table>
  </div>
  <style type="text/css">
  ...
  <div class="card-body">
    <div class="table-responsive">
        <td><div class="col-xl-10 col-md-6 mb-4" >
              <a href="{{url('manager/breakfast')}}" class="nounderline">
              ...
              <td><div class="col-xl-10 col-md-6 mb-4" >
              <a href="{{url('manager/lunch')}}" class="nounderline">
            ...
            <td><div class="col-xl-10 col-md-6 mb-4" >
              <a href="{{url('manager/dinner')}}" class="nounderline">
 ...
 <td><div class="col-xl-10 col-md-6 mb-10" >
              <a href="{{url('manager/dessert')}}" class="nounderline">
              ...
              <td><div class="col-xl-10 col-md-6 mb-10" >
              <a href="{{url('manager/drink')}}" class="nounderline">
            ...
            <td><div class="col-xl-10 col-md-6 mb-10" >
              <a href="{{url('manager/snack')}}" class="nounderline">
