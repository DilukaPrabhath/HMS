     ...
     <!--  <table width="100%">
          <tr>
            <td><h5 class="m-0 font-weight-bold text-dark col-md-4">Customer Table</h5></td>
                        ...
                        <label>Generated By: {{ Auth::user()->fname }} {{ Auth::user()->lname }} </label>
                        <label class="text-align-right">
                            <p>Generated Date/Time:
  ...
  <div class="card-body">
    <div class="table-responsive">
      ...
      <thead style="background-color:#F5F5F5; border: 0.1mm solid #eee;">
                  ...
                  @endforeach
                  <h4 style="color:red; text-align: right;">{{ \DB::table('customers')->where('status','=','0')->count()}} Customers on Report</h4>
                  </tbody><br><br><br>
                </table>
