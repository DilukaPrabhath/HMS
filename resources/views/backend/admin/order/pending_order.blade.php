          ...
          <table class="table table-bordered" id="example2" width="100%" cellspacing="0">
            ...
            <tbody> @foreach($orders as $value)
              <tr>
                ...
                <td> @if ($value->status == 0) <span class="badge badge-warning">Pending</span> @else @endif
                  <td class="project-actions">
                    <a class="btn btn-danger btn-circle btn-sm" href="{{url('admin/FeedbackOrder')}}/{{$value->id}}"> <i class="fa fa-edit" aria-hidden="true"></i> </i>
                    </a>
                  </td>
              </tr> @endforeach </tbody>
          </table>
