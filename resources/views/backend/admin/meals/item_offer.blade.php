...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <form method="post" action="{{url('admin/offer/save')}}" enctype="multipart/form-data"> {{ csrf_field() }}
              ...
              <table class="table table-bordered" id="example2" width="100%" cellspacing="0">
                ...
                <tr>
                  ...
                  <td class="project-actions">
                    <a class="btn btn-danger btn-circle btn-sm" href="{{url('admin/offer/view')}}/{{$value->id}}"> <i class="fa fa-edit">
                                     </i> </a>
                  </td>
                </tr> @endforeach </tbody>
              </table>
