...
<div class="row rounded-lg overflow-hidden shadow" style="width:1200px; height: 1000x; border-radius: 30px; margin-left: 50px;">
  ...
  <div class="col-5 px-4">
    <div class="bg-white">
      ...
      <div class="messages-box">
        <div class="list-group rounded-0"> @foreach($message as $value) 
          @if(Auth::user()->id != $value->sender_id) <a href="{{url('admin/message/view')}}/{{$value->sender_id}}" class="list-group-item list-group-item-action list-group-item-light rounded-0">
  ...
  <div class="col-7 px-0">
    <div class="px-4 py-5 chat-box bg-white">
      <!-- Sender Message-->@foreach($chat->sortBy('created_at') as $value) 
