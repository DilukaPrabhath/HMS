    ...
    <div class="bg-white">
      ...
      <div class="messages-box">
        <div class="list-group rounded-0"> 
          @foreach($message->sortBy('created_at') as $value) 
          @if(Auth::user()->id != $value->sender_id) 
          <a href="{{url('admin/message/view')}}/{{$value->sender_id}}" class="list-group-item list-group-item-action list-group-item-light rounded-0">
                @elseif (Auth::user()->id != $value->user_id)
                <a href="{{url('admin/message/view')}}/{{$value->user_id}}" class="list-group-item list-group-item-action list-group-item-light rounded-0">
                @else
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" role="form" method="post" action="{{url('admin/message/save')}}" enctype="multipart/form-data"> {{ csrf_field() }}
