  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <table width="100%">
        <tr>
          <td>
            <h5 class="m-0 font-weight-bold text-dark col-md-4">System Employee Table</h5></td>
          <td><a href="{{url('admin/users/add')}}" class="col-md-4 btn btn-block btn-dark float-right">Add Employee</a></td>
        </tr>
      </table>
    </div>
    <div class="card-body">
