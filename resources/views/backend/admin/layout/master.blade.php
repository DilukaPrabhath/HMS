...
<link href="{{asset('hms2020/css/calender.css')}}" rel="stylesheet">
<script src="{{asset('hms2020/js/calender-min.js')}}"></script>
...
@include('backend.admin.layout.saidenavbar')
  ...
  <script src="{{asset('hms2020/js/demo/chart-bar-demo.js')}}"></script>
