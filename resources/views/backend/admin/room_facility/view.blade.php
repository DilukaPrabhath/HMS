...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <form method="" action="" enctype="multipart/form-data"> {{ csrf_field() }}
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <button type="submit" class="btn btn-primary">ok</button> --}} <a href="{{url('admin/facility')}}" class="btn btn-info">Back</a> </div>
          <div class="form-group col-md-6">
