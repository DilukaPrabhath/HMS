...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <form method="post" action="{{url('admin/room/details/update')}}/{{$room[0]->id}}" enctype="multipart/form-data"> {{ csrf_field() }}
        <div class="form-row">
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="price" name="price" placeholder="" value="{{$room[0]->price}}"> @error('room_no')
            <div class="alert" style="color: red;padding-left: 0px;">{{ $message }}</div> @enderror </div>
        </div>
        <div class="form-row">
          <div class="form-group col-md-6">
