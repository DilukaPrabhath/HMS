...
<form class="customer" method="POST" action="{{url('admin/customers/view')}}/{{$data[0]->id}}" enctype="multipart/form-data"> {{csrf_field()}}
  <div class="container">
    <div class="main-body">
        ...
        <div class="col-md-8">
          <div class="card mb-3">
            <div class="card-body">
              ...
              <hr>
              <div class="row">
                <div class="col-sm-12"> <a class="btn btn-info " href="{{url('admin/customers/edit')}}/{{$data[0]->id}}">Edit</a> </div>
              </div>
            </div>
          </div>
