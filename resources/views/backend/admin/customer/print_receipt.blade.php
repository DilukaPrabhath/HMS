   ...
   <div class="col-md-12">
      <div class="invoice">
         ...
         <div class="invoice-company text-inverse f-w-600">
            ...
            <a href="#" onclick="window.print()" class="btn btn-sm btn-white m-b-10 p-l-5" ><i class="fa fa-file t-plus-1 text-danger fa-fw fa-lg"></i> Export as PDF</a>
		...
		<form class="customer" method="POST" action="{{url('admin/customers/printreceipt')}}/{{$print[0]->id}}" enctype="multipart/form-data"> {{csrf_field()}}
            ...
            <div class="table-responsive">
               <table class="table table-invoice">
                  ...
                  <tbody>
                     <tr>
                        <td>
                           <span class="text-inverse"><strong>Room Type:</strong> {{$print[0]->roomtype}} <strong style="color:red;">&amp;</strong> <strong>Room No:</strong> {{$print[0]->room_name}}</span><br>
                        </td>
                     ...
                     <tr>
                        <td>
                           <span class="text-inverse"><strong>Order ID: </strong>{{$value->oid}}</span><br>
