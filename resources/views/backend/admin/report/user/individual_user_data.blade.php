  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <table width="100%">
        <tr>
          <td>
            <h5 class="m-0 font-weight-bold text-dark col-md-4">Individual User Data</h5></td>
        ...
        <table class="table table-bordered" id="example2" width="100%" cellspacing="0">
          ...
          <tr>
            ...
            <td class="project-actions">
              <a class="btn btn-info btn-circle btn-sm" href="{{url('individualuserreportview')}}/{{$value->id}}" target="_blank"> <i class="fa fa-download">
               </i> </a>
            </td>
          </tr> @endforeach </tbody>
        </table>
