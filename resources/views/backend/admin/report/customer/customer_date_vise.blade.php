          ...
          <div class="table-responsive">
            <div class="container">
              ...
              <div class="row input-daterange">
                <div class="col-md-4">
                  <form class="customer" method="get" action="{{url('exportall')}}" enctype="multipart/form-data">
                     {{csrf_field()}}
              ...
              <div class="card shadow mb-4">
                <div class="card-body">
                  <div class="table-responsive">
                    <div>
                    <input class="btn btn-dark" value="Export Data" type="submit" />
