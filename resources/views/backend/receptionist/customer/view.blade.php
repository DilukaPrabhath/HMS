...
<form class="customer" method="POST" action="{{url('receptionist/customers/view')}}/{{$data[0]->id}}" enctype="multipart/form-data"> {{csrf_field()}}
  <div class="container">
    <div class="main-body">
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-9 text-secondary"> 
                  @if ($data[0]->room_type_id == 1) Single 
                  @elseif ($data[0]->room_type_id == 2) Double 
                  @elseif ($data[0]->room_type_id == 3) Family 
                  @elseif ($data[0]->room_type_id == 4) Suite 
                  @else ($data[0]->room_type_id == 5) Double Extra 
                @endif 
              </div>
              </div>
              <hr>
              ...
              <hr>
              <div class="row">
                <div class="col-sm-12"> <a class="btn btn-info " href="{{url('receptionist/customers/edit')}}/{{$data[0]->id}}">Edit</a> </div>
              </div>
            </div>
          </div>
