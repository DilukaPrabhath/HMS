...
<div class="card shadow mb-4">
  <div class="card-header py-3">
      <table width="100%">
          <tr>
            <td><h5 class="m-0 font-weight-bold text-dark col-md-4">CheckIn List</h5></td>
          </tr>
    ...
    <div class="table-responsive">
      ...
      <thead style="background-color:#F5F5F5;">
                    ...
                    <td class="project-actions">
                          <a class="btn btn-danger btn-circle btn-sm" href="{{url('receptionist/customers/checkout')}}/{{$value->id}}">
                              <i class="fa fa-edit">
                              </i>
                          </a>
                      </td>
