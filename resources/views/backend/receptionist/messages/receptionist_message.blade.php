  ...
  <div class="col-5 px-4">
    <div class="bg-white">
      ...
      <div class="messages-box">
        <div class="list-group rounded-0"> @foreach($message->sortBy('created_at') as $value) @if(Auth::user()->id != $value->sender_id) <a href="{{url('receptionist/message/view')}}/{{$value->sender_id}}" class="list-group-item list-group-item-action list-group-item-light rounded-0">
