...
<div class="container-fluid">
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"></h1> <a href="{{url('admin/room/add')}}" class="btn btn-success btn-circle btn-lg"><i class="fas fa-plus"></i></a> </div>
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
          ...
          <tbody> @foreach($rooms as $value)
            <tr>
              ...
              <td class="project-actions">
                <a class="btn btn-info btn-circle btn-sm" href="testimonial/view/"> <i class="fa fa-eye">
                              </i> </a>
