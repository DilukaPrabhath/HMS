...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h5 class="m-0 font-weight-bold text-dark">Release Room</h5> </div>
    <div class="card-body">
      <style type="text/css">
    .lb {
        text-align: center;
      ...
      <form method="post" action="{{url('receptionist/room/edit/update')}}/{{$rooms[0]->id}}" enctype="multipart/form-data"> {{ csrf_field() }}
