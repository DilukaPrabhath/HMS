...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Dashboard-Chef </h1> </div>
    <style type="text/css">
    .card {
            ...
            <div class="row ">
                <div class="col-xl-3 col-lg-6">
                    <div class="card l-bg-cherry">
                        <div class="card-statistic-3 p-4">
                            <div class="mb-4">
                                <h6 class="card-title mb-0">Total Earnings (Complete Orders)</h6> </div>
                ...
                <div class="col-xl-3 col-lg-6">
                    <div class="card l-bg-blue-dark">
                        <div class="card-statistic-3 p-4">
                            <div class="mb-4">
                                <h6 class="card-title mb-0">Total Customers</h6> </div>
                            <div class="row align-items-center mb-2 d-flex">
                                <div class="col-8">
                                    <h3 class="d-flex align-items-center mb-0">
                               <h3 class="d-flex align-items-center mb-0">{{\DB::table('customers')->where('status','=','1')->count()}}</h3> </h3>
                                </div>
